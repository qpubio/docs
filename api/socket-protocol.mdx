...
The Socket protocol is a JSON message format over a WebSocket. Prefer an [official SDK](/getting-started/sdks.mdx) unless you are writing a custom client.
...
The server may reply with action `9` (`published`). Custom clients can ignore it; the official SDK treats publish as fire-and-forget.
