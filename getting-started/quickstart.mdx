...
Get a working pub/sub loop with `@qpub/sdk` in a few minutes. Use the **API** and **Language** controls (right rail on desktop, or at the top of the docs menu on mobile) to switch **Socket** vs **REST** and **JavaScript** vs **React** — samples and notes update together.
