...
QPub Cloud uses `_stats` to power its live charts. You can build your own real-time monitoring with the same data.
...
The Cloud Console uses `_logs` to display live activity. Subscribe programmatically to build your own audit trail or monitoring dashboard.
