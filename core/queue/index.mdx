...
Producers need `enqueue` (or `publish`) on the queue name. Workers need `dequeue` (or `subscribe`). See [Permissions](/docs/core/auth/permissions).

## Next

- [Jobs](/docs/core/queue/jobs)
- [Workers](/docs/core/queue/workers)
- [REST SDK Queues](/docs/api/rest-sdk/queues)
