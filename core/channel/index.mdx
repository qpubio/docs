...
Access is controlled by [permissions](/docs/core/auth/permissions) on the API key or JWT, not by channel “types”.
...
See [Using Channels](/docs/core/channel/using) and [Pub/Sub](/docs/core/pubsub).
