...
Create and rotate keys in the [dashboard](/dashboard/api-keys).
...
- For browsers, use [Token Auth](/core/auth/token).
- Scope keys with [permissions](/core/auth/permissions) when creating them in the dashboard.
