...
Create and rotate keys in the [dashboard](/docs/dashboard/api-keys).
...
- For browsers, use [Token Auth](/docs/core/auth/token).
- Scope keys with [permissions](/docs/core/auth/permissions) when creating them in the dashboard.
