...
For browsers, do not embed the secret. Issue a [JWT or token request](/docs/core/auth/token) from your backend instead.

## Permissions

Keys can carry a permission map (`publish`, `subscribe`, `enqueue`, …). See [Permissions](/docs/core/auth/permissions).
