...
For browsers, do not embed the secret. Issue a [JWT or token request](/core/auth/token) from your backend instead.

## Permissions

Keys can carry a permission map (`publish`, `subscribe`, `enqueue`, …). See [Permissions](/core/auth/permissions).
