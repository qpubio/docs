...
1. Create a project and API key in the [dashboard](/docs/dashboard).
2. On your server, keep the API key secret.
3. For browsers, issue a JWT or signed [token request](/docs/core/auth/token) with limited permissions.
...
- [Authentication](/docs/core/auth)
- [Publish](/docs/core/pubsub/publish) / [Subscribe](/docs/core/pubsub/subscribe)
