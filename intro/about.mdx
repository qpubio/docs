...
- Not a full application backend (auth for your end users is your responsibility; QPub authenticates *your apps* to the messaging APIs)
- Not a channel CRUD product — channels are named topics you publish/subscribe to by string
- TODO: self-hosted deployment options are not documented here
